/*using System; using JameNegar.Constants;
...
namespace JameNegar.CustomControls.CircularProgressBar
{
    /// <summary>
    ///     The circular progress bar windows form control
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(P_CircularProgressBar), "CircularProgressBar.bmp")]
    [DefaultBindingProperty("Value")]
    public class P_CircularProgressBar : ProgressBar
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="P_CircularProgressBar" /> class.
        /// </summary>
        public P_CircularProgressBar()
        {
            SetStyle(
            ...
            SuperscriptMargin = new Padding(5, 15, 0, 0);
            SuperscriptColor = Color.Black;
            SuperscriptText = "%";
        ...
        /// <summary>
        ///     Gets or sets the font of text in the <see cref="P_CircularProgressBar" />.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///     Gets or sets the text in the <see cref="P_CircularProgressBar" />.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Browsable(true)]
