...
{
    public class P_P_CircularProgressBar : Control
    {
        #region Enums
        ...
        public P_P_CircularProgressBar()
        {
        ...
        /*        [Description("Color Final de la Barra de Progreso"), Category("Dedicated Appearance")]
        ...
        */
        ...
        [Description("Valor Entero que determina la posision de la Barra de Progreso."), Category("Dedicated Behavior")]
        public long Value
        {
            get { return _Value; }
            set
        ...
        [Description("Obtiene o Establece el Valor Maximo de la barra de Progreso."), Category("Dedicated Behavior")]
        public long Maximum
        {
            get { return _Maximum; }
            set
        ...
        [Description("Color Inicial de la Barra de Progreso"), Category("Dedicated Appearance")]
        ...
        [Description("Ancho de la Barra de Progreso"), Category("Dedicated Appearance")]
        ...
        [Description("Modo del Gradiente de Color"), Category("Dedicated Appearance")]
        ...
        [Description("Color de la Linea Intermedia"), Category("Dedicated Appearance")]
        ...
        [Description("Ancho de la Linea Intermedia"), Category("Dedicated Appearance")]
        ...
        [Description("Obtiene o Establece la Forma de los terminales de la barra de progreso."), Category("Dedicated Appearance")]
        ...
        [Description("Obtiene o Establece el Modo como se muestra el Texto dentro de la barra de Progreso."), Category("Dedicated Behavior")]
        ...
        [Description("Obtiene el Texto que se muestra dentro del Control"), Category("Dedicated Behavior")]
