...
namespace JameNegar.CustomControls.Design
{
    ...
    public class MultiPaneControlDesigner : System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        {
            MultiPaneControl aCtl = DesignedControl;
            System.Drawing.Point pt = aCtl.PointToClient(new System.Drawing.Point(theDragEvents.X, theDragEvents.Y));
    ...
    public class MultiPanePageDesigner : ScrollableControlDesigner
    {
        private Pen
            myBorderPen_Light,
            myBorderPen_Dark;
        ...
        public void InternalOnDragDrop(DragEventArgs theArgs)
        {
            OnDragDrop(theArgs);
        }

        public void InternalOnDragEnter(DragEventArgs theArgs)
        {
            OnDragEnter(theArgs);
        }

        public void InternalOnDragLeave(EventArgs theArgs)
        {
            OnDragLeave(theArgs);
        }

        public void InternalOnGiveFeedback(GiveFeedbackEventArgs theArgs)
        {
            OnGiveFeedback(theArgs);
        }

        public void InternalOnDragOver(DragEventArgs theArgs)
        {
            OnDragOver(theArgs);
        }
    ...
    public class MultiPaneControlSelectedPageEditor : ObjectSelectorEditor
    {
