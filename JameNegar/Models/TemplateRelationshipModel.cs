    ...
    public class TemplateRelationshipModel
    {
        ...
        internal TemplateRelationshipModel(int order, string id, string fileName, string resourcePath, bool isRequired)
        {
            ...
            switch (id)
            {
                ...
                //    break;
                case "Research":
                    PageTitle = "شناسنامه فارسی تحقیق درسی";
                    SubTemplateID = SubTemplateIDs.Research;
                    PageID = PageIDs._page_PersianIdentity_Research;
                    break;
                case "Project":
                    PageTitle = "شناسنامه فارسی پروژه";
                    SubTemplateID = SubTemplateIDs.Project;
                    PageID = PageIDs._page_PersianIdentity_Project;
                    break;
                case "Karvarzi":
                    PageTitle = "شناسنامه فارسی کارورزی";
                    SubTemplateID = SubTemplateIDs.Karvarzi;
                    PageID = PageIDs._page_PersianIdentity_Karvarzi;
                    break;
