...
namespace JameNegar.Forms.ChangeContents
{
    public partial class ChangeContentsForm : Form
    {
        ...
        public ChangeContentsForm(Microsoft.Office.Interop.Word.Document doc)
        {
            ...
            changeContentsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            changeContentsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            changeContentsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            changeContentsControl.MouseDown += ChangeContentsControl_MouseDown;
        }
