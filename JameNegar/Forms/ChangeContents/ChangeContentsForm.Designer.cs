...
namespace JameNegar.Forms.ChangeContents
{
    partial class ChangeContentsForm
    {
        ...
        private void InitializeComponent(Document doc)
        {
            ...
            this.changeContentsControl = new JameNegar.Forms.ChangeContents.ChangeContentsControl(doc);
            this.SuspendLayout();
            // 
            // timerOpenAnimation
            // 
            ...
            this.elementHost1.Child = this.changeContentsControl;
            // 
            // DocumentManagerForm
            // 
        ...
        public ChangeContentsControl changeContentsControl;
    }
}