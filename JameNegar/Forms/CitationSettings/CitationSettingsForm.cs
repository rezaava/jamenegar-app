...
namespace JameNegar.Forms.CitationSettings
{
    public partial class CitationSettingsForm : Form
    {
        [Flags]
        ...
        internal CitationSettingsForm(Microsoft.Office.Interop.Word.Document doc, DedicatedFunctions.AccessType accessType)
        {
            InitializeComponent(doc, accessType);
            ...
            citationSettingsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            citationSettingsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            citationSettingsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            citationSettingsControl.MouseDown += ChangeContentsControl_MouseDown;
        }
        ...
        private void CitationSettingsForm_Load(object sender, EventArgs e)
        {
