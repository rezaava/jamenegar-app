...
namespace JameNegar.Forms.VirastarSettings
{
    public partial class VirastarSettingsForm : Form
    {
        ...
        public VirastarSettingsForm(Microsoft.Office.Interop.Word.Document doc)
        {
            ...
            virastarSettingsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            virastarSettingsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            virastarSettingsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            virastarSettingsControl.MouseDown += ChangeContentsControl_MouseDown;
        }
