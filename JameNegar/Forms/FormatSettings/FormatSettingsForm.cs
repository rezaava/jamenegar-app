...
namespace JameNegar.Forms.FormatSettings
{
    public partial class FormatSettingsForm : Form
    {
        ...
        internal FormatSettingsForm(Microsoft.Office.Interop.Word.Document doc, DedicatedFunctions.AccessType accessType)
        {
            ...
            formatSettingsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            formatSettingsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            formatSettingsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            formatSettingsControl.MouseDown += ChangeContentsControl_MouseDown;
        }
