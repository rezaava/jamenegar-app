...
namespace JameNegar.Forms.FormatSettings
{
    partial class FormatSettingsForm
    {
        ...
        private void InitializeComponent(Document doc, DedicatedFunctions.AccessType accessType)
        {
            ...
            this.formatSettingsControl = new JameNegar.Forms.FormatSettings.FormatSettingsControl(doc,accessType);
            this.SuspendLayout();
            // 
            // timerOpenAnimation
            // 
            ...
            this.elementHost1.Child = this.formatSettingsControl;
            // 
            // DocumentManagerForm
            // 
        ...
        public FormatSettingsControl formatSettingsControl;
    }
}