...
using JameNegar.Forms.JameNegarManager.DocumentManager.Models;
...
{
    public partial class JameNegarControl : System.Windows.Controls.UserControl, Interfaces.ICloseForm
    {
        public Action CloseForm { get; set; }

        string updateLink = "";

        public JameNegarControl(bool initialize)
        {
