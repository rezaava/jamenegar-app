...
namespace JameNegar.Forms.JameNegarManager
{
    partial class JameNegarForm
    {
        ...
        /// </summary>
        private void InitializeComponent(bool initialize)
        {
			this.components = new System.ComponentModel.Container();
			this.timerOpenAnimation = new System.Windows.Forms.Timer(this.components);
			this.elementHost1 = new System.Windows.Forms.Integration.ElementHost();
			this.shivaNegarControl = new JameNegar.Forms.JameNegarManager.JameNegarControl(initialize);
			this.SuspendLayout();
			// 
			// timerOpenAnimation
			// 
			...
			this.elementHost1.Child = this.shivaNegarControl;
			// 
			// JameNegarForm
			// 
		...
		private JameNegarControl shivaNegarControl;
	}
}