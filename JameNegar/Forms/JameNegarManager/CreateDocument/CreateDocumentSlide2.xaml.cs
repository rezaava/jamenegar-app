...
using JameNegar.Forms.JameNegarManager.DocumentManager.ViewModel;
...
namespace JameNegar.Forms.JameNegarManager.CreateDocument
{
    public partial class CreateDocumentSlide2 : UserControl
    {
        ...
        public CreateDocumentSlide2()
        {
            ...
            comboDocumentType.Items.Add("تحقیق درسی");
        ...
        private async void btnStore_Click(object sender, RoutedEventArgs e)
        {
            ...
            //    string resourceName = "JameNegar.Templates.Blank.docx";

            //    // اگر نام پروژه Jamenegar است و فایل در پوشه Templates است:
            //    // resourceName = "Jamenegar.Templates.Blank.docx";
            ...
            //        {
            //            var documentVM = dc.CurrentView as JameNegar.Forms.JameNegarManager.DocumentManager.ViewModel.DocumentsVM;
            //            if (documentVM != null)
            //            {
        ...
        private async System.Threading.Tasks.Task ValidateDocumentTypeWithServer(string documentType)
        {
            ...
            OnResult =>
            {
                ...
                if (root.TryGetProperty("status", out JsonElement statusElement) && statusElement.GetString() == "1")
                {
                    ...
                    // فقط اگه اسم سند پر بود، دکمه بعدی فعال بشه
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            // ✅ بعد از تغییر اسم سند، دکمه بعدی رو دوباره بررسی کن
        ...
        private bool validateControls()
        {
            ...
            if (validateDocumentType && validateTemplateType && validateDocumentName && validateDocumentNameInServer)
            {
                ...
                btnForward.IsEnabled = true;  // ✅ اضافه شد
            ...
            {
                btnForward.IsEnabled = false;  // ✅ اضافه شد
                return false;
            }
        }
