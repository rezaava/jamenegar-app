...
namespace JameNegar.Forms.JameNegarManager
{
    ...
    public partial class JameNegarForm : Form
    {
        [Flags]
        ...
        public JameNegarForm(bool initialize)
        {
            ...
            if (initialize)
            {
                ...
                shivaNegarControl.MouseDown += JameNegarControl_MouseDown;
            }
        }
        ...
        private void JameNegarControl_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            releaseCapture();
        ...
        public JameNegarControl GetMainControl()
        {
