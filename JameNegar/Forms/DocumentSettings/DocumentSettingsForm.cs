...
namespace JameNegar.Forms.DocumentSettings
{
    public partial class DocumentSettingsForm : Form
    {
        ...
        public DocumentSettingsForm(Microsoft.Office.Interop.Word.Document doc)
        {
            ...
            documentSettingsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            documentSettingsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            documentSettingsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            documentSettingsControl.MouseDown += ChangeContentsControl_MouseDown;
        }
