...
namespace JameNegar.Forms.CaptionSettings
{
    public partial class CaptionsReferSettingsForm : Form
    {
        ...
        public CaptionsReferSettingsForm(Microsoft.Office.Interop.Word.Document doc)
        {
            ...
            captionSettingsControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            captionSettingsControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            captionSettingsControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            captionSettingsControl.MouseDown += ChangeContentsControl_MouseDown;

            captionSettingsControl.toggleButtonAlwaysOnTop.Click += ToggleButtonAlwaysOnTop_Click;
            captionSettingsControl.toggleButtonAlwaysOnTop.IsChecked = true;
            this.TopMost = true;
        }

        private void ToggleButtonAlwaysOnTop_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            if (captionSettingsControl.toggleButtonAlwaysOnTop.IsChecked == true)
                this.TopMost = true;
            else
                this.TopMost = false;
        }
