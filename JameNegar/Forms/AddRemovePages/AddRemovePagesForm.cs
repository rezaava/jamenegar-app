...
namespace JameNegar.Forms.AddRemovePages
{
    public partial class AddRemovePagesForm : Form
    {
        ...
        public AddRemovePagesForm(Microsoft.Office.Interop.Word.Document doc)
        {
            ...
            addRemovePagesControl.CloseFormRequest += () =>//CloseFormButton Event
            {
                closeForm();
            };
            addRemovePagesControl.MaximizeStateFormRequest += () =>//CloseFormButton Event
            {
            ...
            addRemovePagesControl.MinimizeStateFormRequest += () =>//CloseFormButton Event
            {
                this.WindowState = FormWindowState.Minimized;
            };

            addRemovePagesControl.MouseDown += ChangeContentsControl_MouseDown;
        }
