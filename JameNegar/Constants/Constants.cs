...
namespace JameNegar.Constants
{
    ...
    {
        internal const string JameNegarShortcut = "JameNegar.Constants.JameNegarShortcut.dotm";

        internal const string HalfSpace = "JameNegar.Constants.VirastarFiles.HalfSpace.csv";
        internal const string Standard = "JameNegar.Constants.VirastarFiles.Standard.csv";
        internal const string Tanvin = "JameNegar.Constants.VirastarFiles.Tanvin.csv";
        internal const string Signs = "JameNegar.Constants.VirastarFiles.Signs.csv";
        internal const string Tashdid = "JameNegar.Constants.VirastarFiles.Tashdid.csv";
        internal const string SpellingCorrection = "JameNegar.Constants.VirastarFiles.SpellingCorrection.csv";

        internal const string Khotbeh = "JameNegar.Constants.NahjBalagheFiles.Khotbeh.csv";
        internal const string Nameh = "JameNegar.Constants.NahjBalagheFiles.Nameh.csv";
        internal const string Hekmat = "JameNegar.Constants.NahjBalagheFiles.Hekmat.csv";

        internal const string Ayeh = "JameNegar.Constants.QuranFiles.Ayeh.csv";
        internal const string Surah = "JameNegar.Constants.QuranFiles.Surah.csv";

        internal const string Dedicate = "JameNegar.Constants.OtherFiles.Dedicate.csv";

        internal const string DefenseAnnouncements = "JameNegar.Templates.DefenseAnnouncements.xml";
        internal const string Templates = "JameNegar.Templates.Templates.xml";

        internal const string Universities = "JameNegar.Constants.Universities.xml";

        internal const string B_Yagut = "JameNegar.Resources.B Yagut.ttf";
        internal const string B_Yagut_Bold = "JameNegar.Resources.B Yagut Bold.ttf";

        internal const string B_Badr_Bold = "JameNegar.Resources.B Badr Bold.ttf";
        internal const string B_Badr = "JameNegar.Resources.B Badr.ttf";
        internal const string B_Lotus_Bold = "JameNegar.Resources.B Lotus Bold.ttf";
        internal const string B_Lotus = "JameNegar.Resources.B Lotus.ttf";
        internal const string B_Nazanin_Bold = "JameNegar.Resources.B Nazanin Bold.ttf";
        internal const string B_Nazanin = "JameNegar.Resources.B Nazanin.ttf";
        internal const string B_Titr_Bold = "JameNegar.Resources.B Titr Bold.ttf";
        internal const string B_Zar_Bold = "JameNegar.Resources.B Zar Bold.ttf";
        internal const string B_Zar = "JameNegar.Resources.B Zar.ttf";
        internal const string Besmellah_1 = "JameNegar.Resources.Besmellah_1.ttf";
        internal const string Besmellah_2 = "JameNegar.Resources.Besmellah_2.ttf";
        internal const string Besmellah_3 = "JameNegar.Resources.Besmellah_3.ttf";
        internal const string Besmellah_4 = "JameNegar.Resources.Besmellah_4.ttf";
        internal const string IranNastaliq = "JameNegar.Resources.IranNastaliq.ttf";
        internal const string times = "JameNegar.Resources.TIMES.ttf";
        internal const string times_BD = "JameNegar.Resources.TIMESBD.ttf";
        internal const string times_BI = "JameNegar.Resources.TIMESBI.ttf";
        internal const string times_I = "JameNegar.Resources.TIMESI.ttf";
        internal const string Vazir = "JameNegar.Resources.Vazir.ttf";
        internal const string Vazirmatn_Bold = "JameNegar.Resources.Vazirmatn-Bold.ttf";
        internal const string Vazirmatn_Regular = "JameNegar.Resources.Vazirmatn-Regular.ttf";
    }
    ...
    struct StringConstant
    {
        ...
        internal const string NameOfProject = "جامع نگار";
        ...
        internal const string DefaultWorkspaceName = "JameNegarWorkspace";
    ...
    struct DocumentTypeValues
    {
        ...
        internal const string DocumentType_ThesisFa = "گزارش کارورزی";
    ...
    struct TemplateTypeValues
    {
        ...
        internal const string TemplateType_University = "قالب دانشجویی";
        internal const string TemplateType_JameNegar = "قالب جامع نگار";
        ...
        internal const string TemplateType_JameNegarEn = "Jamenegar Template";
    ...
    public enum PageIDs
    {
        ...
        _page_PersianIdentity_Research,
        _page_PersianIdentity_Project,
        _page_PersianIdentity_Karvarzi,
