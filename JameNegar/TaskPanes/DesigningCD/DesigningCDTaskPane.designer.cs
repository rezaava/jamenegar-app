...
namespace JameNegar.TaskPanes.DesigningCD
{
	...
	partial class DesigningCDTaskPane
    {
		...
		private void InitializeComponent()
		{
			...
			this.userControl = new JameNegar.TaskPanes.DesigningCD.DesigningCDControl();
			this.SuspendLayout();
			// 
			// elementHost
			// 
		...
		internal DesigningCDControl userControl;
	}
}
